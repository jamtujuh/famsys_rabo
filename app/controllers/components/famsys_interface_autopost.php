...
class FamsysInterfaceAutopostComponent extends Object {

    private $Config = null;
    private $FamsysInterface = null;
    private $layout = null;
    private $autolayout = null;

    /**
     * Extracted from FamsysInterfacesController::auto_post() with some fixes and modifications.
     */
    ...
    private function add_ft_auto($ExcelGenerate, $ids) {
            ...
            if ($journal_interfases) {
                ...
                if ($sukses) {
                    ...
                    $JournalInterfase->updateAll(
                            array('posting' => 1, 'posting_date' => 'getdate()'), array('posting' => 0)
                    );
    ...
    private function generateCsvAuto($xclData) {
        $out = '';
        $header = '';
