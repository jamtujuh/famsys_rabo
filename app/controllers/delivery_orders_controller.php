...
class DeliveryOrdersController extends AppController {
    ...
    var $components = array('RecordReferer');
		...
		function approved($id = null, $level = null) {
			...
			if ($this->DeliveryOrder->save($this->data)) {
				if($reqType == request_type_stock_id){
					...
					$journal = $InventoryLedger->insert_to_journal('inlog', $inlogId, $this->RecordReferer->getIdByModelNameAndRefName('JournalGroup', 'journal_group_inlog_id'));
				//}else if($reqType == 5){
