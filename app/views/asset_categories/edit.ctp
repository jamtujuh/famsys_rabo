...
<?php echo $this->Form->create('AssetCategory');?>
	<fieldset>
 		<legend><?php __('Edit Asset Category'); ?></legend>
	<?php
		...
		echo $this->Form->input('account_id',array('empty'=>''));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('AssetCategory.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('AssetCategory.id'))); ?></li>
