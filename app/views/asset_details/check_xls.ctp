...
header ("Content-Disposition: attachment; filename=\"" .__('Asset Details Physical Check List', TRUE).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php echo __('Asset Details Physical Check List', TRUE) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	<tr>
		...
		<td bgcolor="#CCCCCC"><div align="center"><?php echo __('Serial Number',true) ;?></div></td>
		<td bgcolor="#CCCCCC"><div align="center"><?php echo __('Checked',true) ;?></div></td>
	</tr>
<?php
	$i = 0;
