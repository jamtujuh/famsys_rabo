...
header ("Content-Disposition: attachment; filename=\"" .__('Monthly Detail Depreciation Report per ', true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php __('Monthly Detail Asset Depreciation Report per ' . $this->Session->read('AssetReport.periode')); ?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	...
	<?php $hpthnlalu += $this->Number->precision($asset['AssetDetail']['hpthnlalu'],0); ?>
	<?php $hpthnini += $this->Number->precision($asset['AssetDetail']['hpthnini'],0); ?>
	<?php $depbln += $this->Number->precision($asset['AssetDetail']['depbln'],0); ?>
	<?php $total += $this->Number->precision($asset['AssetDetail']['book_value_thnlalu'],0); ?>
	<?php $depthnlalu += $this->Number->precision($asset['AssetDetail']['depthnlalu'],0); ?>
	<?php $jan += $this->Number->precision($asset['AssetDetail']['jan'],0); ?>
	<?php $feb += $this->Number->precision($asset['AssetDetail']['feb'],0); ?>
	<?php $mar += $this->Number->precision($asset['AssetDetail']['mar'],0); ?>
	<?php $apr += $this->Number->precision($asset['AssetDetail']['apr'],0); ?>
	<?php $may += $this->Number->precision($asset['AssetDetail']['may'],0); ?>
	<?php $jun += $this->Number->precision($asset['AssetDetail']['jun'],0); ?>
	<?php $jul += $this->Number->precision($asset['AssetDetail']['jul'],0); ?>
	<?php $aug += $this->Number->precision($asset['AssetDetail']['aug'],0); ?>
	<?php $sep += $this->Number->precision($asset['AssetDetail']['sep'],0); ?>
	<?php $oct += $this->Number->precision($asset['AssetDetail']['oct'],0); ?>
	<?php $nov += $this->Number->precision($asset['AssetDetail']['nov'],0); ?>
	<?php $dec += $this->Number->precision($asset['AssetDetail']['dec'],0); ?>
