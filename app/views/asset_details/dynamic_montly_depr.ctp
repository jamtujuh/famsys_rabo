...
<div id="filter">
	...
	<? echo $form->create('AssetDetail', array('action' => 'dynamic_montly_depr')); ?>
		<fieldset>
...
<div class="related">
      <? if (!empty($assets)) : ?>	
            <h2><?php __('Dynamic Monthly Detail Asset Depreciation Report per ' . $this->Session->read('AssetReport.periode')); ?></h2>
			...
			<?php $depthnlalu += $asset['AssetDetail']['depthnlalu']; ?>
                        <?php $book_value_thnlalu += $asset['AssetDetail']['book_value_thnlalu']; ?>
