...
header ("Content-Disposition: attachment; filename=\"" .__('Monthly Depreciation Recap Asset Category per', true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php echo __('Monthly Depreciation Recap Asset Category '.$this->Session->read('AssetReport.periode'), true) ;?></h2></td>
	</tr>
	<tr>
