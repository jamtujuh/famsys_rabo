...
header ("Content-Disposition: attachment; filename=\"" .__('Monthly Depreciation Report',true).'-'. gmdate("d M Y") . ".xls" );
//header ("Content-Description: Generated Report" );
?>
<?php
$is_inventory = $this->Session->read('AssetReport.is_inventory');
$date_end = $this->Session->read('Asset.date_end');
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php echo __('Monthly Depreciation Report per ' . $date_end['year']  . '-' . $date_end['month'] . '-15', true  ) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	<tr>
		...
		<td bgcolor="#CCCCCC"><div align="center"><?php echo __('Total Acg. Cost',true) ;?></div></td>
	...
	<tr<?php echo $class;?>>
		...
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['hpthnini'],0  ) ?></td>
		...
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['jan'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['feb'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['mar'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['apr'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['may'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['jun'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['jul'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['aug'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['sep'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['oct'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['nov'],0 ); ?></td>
		<td align="right"><?php echo $this->Number->precision( $asset['Asset']['dec'],0 ); ?></td>
		...
		<?php $hpthnini += $this->Number->precision($asset['Asset']['hpthnini'],0); ?>
		<?php $depbln += $this->Number->precision($asset['Asset']['depbln'],0); ?>
		<?php $ttl += $this->Number->precision($asset['Asset']['book_value_thnlalu'],0) ; ?>
		<?php $depthnlalu += $this->Number->precision($asset['Asset']['depthnlalu'],0) ; ?>
		<?php $jan += $this->Number->precision($asset['Asset']['jan'],0) ; ?>
		<?php $feb += $this->Number->precision($asset['Asset']['feb'],0) ; ?>
		<?php $mar += $this->Number->precision($asset['Asset']['mar'],0) ; ?>
		<?php $apr += $this->Number->precision($asset['Asset']['apr'],0) ; ?>
		<?php $may += $this->Number->precision($asset['Asset']['may'],0) ; ?>
		<?php $jun += $this->Number->precision($asset['Asset']['jun'],0) ; ?>
		<?php $jul += $this->Number->precision($asset['Asset']['jul'],0) ; ?>
		<?php $aug += $this->Number->precision($asset['Asset']['aug'],0) ; ?>
		<?php $sep += $this->Number->precision($asset['Asset']['sep'],0) ; ?>
		<?php $oct += $this->Number->precision($asset['Asset']['oct'],0) ; ?>
		<?php $nov += $this->Number->precision($asset['Asset']['nov'],0) ; ?>
		<?php $dec += $this->Number->precision($asset['Asset']['dec'],0) ; ?>
...
<?php endforeach; ?>
	<tr>
		...
		<td align="right"><?php echo $this->Number->precision($ttl,0); ?></td>
