<div class="aydaInsurances view">
<h2><?php  __('Ayda Insurance');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaInsurance['AydaInsurance']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nama'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaInsurance['AydaInsurance']['nama']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Ayda Insurance', true), array('action' => 'edit', $aydaInsurance['AydaInsurance']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Ayda Insurance', true), array('action' => 'delete', $aydaInsurance['AydaInsurance']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $aydaInsurance['AydaInsurance']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($aydaInsurance['Ayda'])):?>
	...
	<?php
		$i = 0;
		foreach ($aydaInsurance['Ayda'] as $ayda):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
