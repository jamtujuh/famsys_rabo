<div class="aydaStatuses view">
<h2><?php  __('Ayda Status');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaStatus['AydaStatus']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nama'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaStatus['AydaStatus']['nama']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Low'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaStatus['AydaStatus']['low']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('High'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaStatus['AydaStatus']['high']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Ayda Status', true), array('action' => 'edit', $aydaStatus['AydaStatus']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Ayda Status', true), array('action' => 'delete', $aydaStatus['AydaStatus']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $aydaStatus['AydaStatus']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($aydaStatus['Ayda'] as $ayda):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
