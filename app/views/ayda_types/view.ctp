<div class="aydaTypes view">
<h2><?php  __('Ayda Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaType['AydaType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nama'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $aydaType['AydaType']['nama']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Ayda Type', true), array('action' => 'edit', $aydaType['AydaType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Ayda Type', true), array('action' => 'delete', $aydaType['AydaType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $aydaType['AydaType']['id'])); ?> </li>
