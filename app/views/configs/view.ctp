...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Config', true), array('action' => 'edit', $config['Config']['key'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Config', true), array('action' => 'delete', $config['Config']['key']), null, sprintf(__('Are you sure you want to delete # %s?', true), $config['Config']['key'])); ?> </li>
