...
<?php echo $this->Form->create('DeliveryOrderDetail');?>
	<fieldset>
 		<legend><?php __('Edit Delivery Order Detail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('DeliveryOrderDetail.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('DeliveryOrderDetail.id'))); ?></li>
