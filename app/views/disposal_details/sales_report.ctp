...
<div id="filter">
	...
	<fieldset>
	<legend><?php __('FA Sales Filters')?></legend>
...
<div class="related">
	...
	foreach ($disposalDetails as $disposalDetail):
		...
		$total_sales_amount			+=$disposalDetail['DisposalDetail']['sales_amount'];
		$total_loss_profit_amount	+=$disposalDetail['DisposalDetail']['loss_profit_amount'];
	...
	<tr<?php echo $class;?>>
		...
		<td class="number"><?php echo $this->Number->format($disposalDetail['DisposalDetail']['sales_amount']); ?></td>
		<td class="number"><?php echo $this->Number->format($disposalDetail['DisposalDetail']['loss_profit_amount']); ?></td>
...
<?php endforeach; ?>
	<tr>
		...
		<td class="number"><?php echo $this->Number->format($total_sales_amount) ?></td>
		<td class="number"><?php echo $this->Number->format($total_loss_profit_amount) ?></td>
