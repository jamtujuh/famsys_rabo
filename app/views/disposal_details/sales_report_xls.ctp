...
header ("Content-Disposition: attachment; filename=\"" .__('Disposal Sales Report',true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php echo __('Disposal Sales Report', true  ) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	<tr>
		...
		<td bgcolor="#CCCCCC"><div align="center"><?php echo __('Sale Amount',true) ;?></div></td>
		<td bgcolor="#CCCCCC"><div align="center"><?php echo __('Lost Profit Amount',true) ;?></div></td>
	...
	<tr<?php echo $class;?>>
		...
		<td align="right"><?php echo $this->Number->precision($disposalDetail['DisposalDetail']['sales_amount'],0); ?></td>
		<td align="right"><?php echo $this->Number->precision($disposalDetail['DisposalDetail']['loss_profit_amount'],0); ?></td>
	...
	<?php
		$total_sales_amount			+=$this->Number->precision($disposalDetail['DisposalDetail']['sales_amount'],0);
		$total_loss_profit_amount	+=$this->Number->precision($disposalDetail['DisposalDetail']['loss_profit_amount'],0);
...
<?php endforeach; ?>
	<tr>
		<td colspan="14"  class="number"><div align="right"><?php __('Total')?></div></td>
		<td align="right"><?php echo $this->Number->precision($total_sales_amount,0) ?></td>
		<td align="right"><?php echo $this->Number->precision($total_loss_profit_amount,0) ?></td>
