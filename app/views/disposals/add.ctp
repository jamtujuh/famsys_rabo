...
<?php echo $this->Form->create('Disposal');?>
	<fieldset>
 		<legend><?php __('Add Disposal '.  ucwords($types[$type])); ?></legend>
	<?php
		...
		echo $this->Form->input('business_type_id', array('options'=>$businessTypes, 'empty'=>'select business type'));
		...
		echo $this->Form->input('CostCenter.name', array('label'=>'Cost Center', 'style'=>'width:50%'));
	?>
