...
<?php echo $this->Form->create('FaSupplierReturDetail');?>
	<fieldset>
 		<legend><?php __('Edit Fa Supplier Retur Detail'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('fa_supplier_retur_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FaSupplierReturDetail.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FaSupplierReturDetail.id'))); ?></li>
