...
<div class="houseKeeping view">
	...
	<tr>
		...
		<th><?php echo __('Outlog No')		;?></th>	
		<th><?php echo __('Outlog Detail')	;?></th>
	</tr>
	
	<?php
		echo $this->Form->create('HouseKeeping', array('action'=>'process_outlogs'));
		$i = 0;
		$n = 0;
	...
	?>
		<tr<?php echo $class;?>>
			...
			<td class="left">
				<?php if($d['id'] != null){ ?>
					<?php echo $this->Html->link($d['no'], array('controller' => 'outlogs', 'action' => 'view', $d['id']));?>
				<?php }; ?>
			</td>
			<td class="left">
				<?php if($d['id'] != null){?>
					Status: <b><?php echo $d['outlog_status_name'];?></b><br>
