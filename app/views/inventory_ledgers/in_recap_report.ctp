<div id="moduleName"><?php echo 'REPORTS > Stock > Stock Inlog Report'?></div>
<div id="close_filter_button"><?php echo $this->Html->link(__('Show/Hide Filters',true), '#', array('onclick'=>'$("filter").toggle()')) ?></div>
<div id="filter">
	<div class="fieldfilter">
	<?php echo $form->create('InventoryLedger', array('action' => 'in_recap_report'));?>
<fieldset>
	<legend><?php __('Stock Inlog Report')?></legend>
	<fieldset class="subfilter">
	<legend><?php __('Stock Inlog Filter') ?></legend>
...
<? if (!empty($inventoryLedgers)) : ?>
	...
	<tr<?php echo $class;?>>
		...
		<td class="left"><?php echo $html->link($pos[$inventoryLedger['InventoryLedger']['po_id']], array('controller' => 'pos', 'action' => 'view', $inventoryLedger['Po']['id'])); ?>&nbsp;</td>
...
<?php endforeach; ?>
	<tr>
		<td style="border-top:1px solid black" colspan="7" class="number"><?php __("Sub Total") ?></td>
