...
header ("Content-Disposition: attachment; filename=\"" .__('Inventory Inlog Recap Report', true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
		<td colspan="4"><h2><?php echo __('Inventory Inlog Recap Report', true) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $pos[$inventoryLedger['InventoryLedger']['po_id']]; ?></td>
...
<?php endforeach; ?>
	<tr>
		<td style="border-top:1px solid black" colspan="7" align="right"><?php echo __('Sub Total',true) ;?></td>
