...
header ("Content-Disposition: attachment; filename=\"" .__('Report In Recap', true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
	<td colspan="4"><h2><?php echo __('Report In Recap', true) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	...
	<tr<?php echo $class;?>>
		<td><?php echo $i; ?></td>
		<td align="left"><?php echo $inventoryLedger['Npb']['no']; ?></td>
