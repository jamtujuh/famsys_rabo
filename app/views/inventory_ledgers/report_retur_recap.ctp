...
$request_type_id = 3;
?>
<div id="moduleName"><?php echo 'REPORTS > Stock > Stock Retur Reports'?></div>
<div id="close_filter_button"><?php echo $this->Html->link(__('Show/Hide Filters',true), '#', array('onclick'=>'$("filter").toggle()')) ?></div>
<div id="filter">
	<div class="fieldfilter">
	<?php echo $this->Form->create('InventoryLedger', array('action'=>'report_retur_recap')) ?>
<fieldset>
...
<div class="InventoryLedger related">
	<h2><?php __('Report Retur Recap');?></h2>
...
<?php endforeach; ?>
	...
	<tr>
		<td colspan="9" class="number">Total</td>
