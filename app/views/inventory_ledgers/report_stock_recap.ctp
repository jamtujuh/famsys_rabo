...
$request_type_id = 3;
?>
<div id="moduleName"><?php echo 'REPORTS > Stock > Stock Reports'?></div>
<div id="close_filter_button"><?php echo $this->Html->link(__('Show/Hide Filters',true), '#', array('onclick'=>'$("filter").toggle()')) ?></div>
<div id="filter">
	<div class="fieldfilter">
	<?php echo $this->Form->create('InventoryLedger', array('action'=>'report_stock_recap')) ?>
<fieldset>
...
<div class="InventoryLedger related">
	<h2><?php __('Report Stock Recap');?></h2>
	...
	<tr<?php echo $class;?>>
		<td><?php echo $i; ?>&nbsp;</td>
		<td class="left">
		<?php echo $inventoryLedger['Npb']['no']; ?>
