...
$request_type_id = 3;
?>
<div id="moduleName"><?php echo 'REPORTS > Stock > Stock Supplier Payable Aging Reports'?></div>
<div id="close_filter_button"><?php echo $this->Html->link(__('Show/Hide Filters',true), '#', array('onclick'=>'$("filter").toggle()')) ?></div>
<div id="filter">
	<div class="fieldfilter">
	<?php echo $this->Form->create('InventoryLedger', array('action'=>'report_supplierpayable_aging')) ?>
<fieldset>
