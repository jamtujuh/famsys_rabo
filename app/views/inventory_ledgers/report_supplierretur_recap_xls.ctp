...
header ("Content-Disposition: attachment; filename=\"" .__('Report Supplierretur Recap', true).'-'. gmdate("d M Y") . ".xls" );
...
<table cellspacing="0" cellpadding="1" border="0">
	<tr>
	<td colspan="4"><h2><?php echo __('Report Supplierretur Recap', true) ;?></h2></td>
	</tr>
	<tr>
...
<table cellspacing="0" cellpadding="1" border="1">
	...
	$amount += $this->Number->precision($inventoryLedger['InventoryLedger']['amount'],0);
	?>
<?php endforeach; ?>
	<tr>
