...
<div id="filter">
	...
	<?php //echo $this->Form->input('is_done',array('options'=>array('0'=>'All','Yes','No'),'value'=>$this->Session->read('Invoice.is_done'))) ?>
	<?php echo $this->Form->input('invoice_status_id',array('options'=>$invoiceStatuses,'empty'=>'all', 'value'=>$this->Session->read('Invoice.status_invoice_id'))) ?>
...
<div class="actions">
	...
	<ul>
		<?php if($this->Session->read('Security.permissions') == gs_group_id || $this->Session->read('Security.permissions') == fincon_group_id) : ?>
...
<div class="related">
	...
	<tr<?php echo $class;?>>
		<td><?php echo $i; ?>&nbsp;</td>
		<td class="left"><?php echo $invoice['Invoice']['no']; ?>&nbsp;</td>
