...
$class = ' class="altrow"'; ?>
        ...
        <dd<?php if ($i++ % 2 == 0)
                echo $class; ?>>
                <?php echo $invoice['Invoice']['rp_rate']; ?>
            &nbsp;
        </dd>		
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
                    ...
                    <td class="number"><?php echo $this->Number->format($invoiceDetail['price'], $places); ?></td>
                    <td class="number"><?php echo $this->Number->format($invoiceDetail['amount'], $places); ?></td>
                    <td class="number"><?php echo $this->Number->format($invoiceDetail['discount'], $places); ?></td>
                    <td class="number"><?php echo $this->Number->format($invoiceDetail['amount_after_disc'], $places); ?></td>
