		...
		Loading, please wait ....
            ...
            <div id="container"> 
                  ...
                  <div id="header"> 
      				...
      				Welcome <?php echo $Userinfo['username'] ?> [<?php echo $this->Html->link('Logout', '/users/logout', array('style' => 'color:red')); ?>]
                                    <br><?php __('Department') ?>: <?php echo $Userinfo['department_name'] ?>
                                          <br><?php __('Cost Center') ?>: <?php echo $Userinfo['business_type_name'] ?> <?php echo $Userinfo['cost_center_name'] ?>
                                                ...
                                                <br>
													  ...
													  <br>
													  <?php __('Password Expires') ?>: <?php echo date('d-M-Y',strtotime($Userinfo['last_password_change'].'+30 day')) ?>
													  
                                                      </div>
                                                <?php endif; ?>			
                                                </div> 

                                                <?php echo $myMenu->render($session->read('Menu.main')); ?>
