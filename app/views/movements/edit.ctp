...
<?php echo $this->Form->create('Movement');?>
	<fieldset>
 		<legend><?php __('Edit Movement'); ?></legend>
	<?php
	...
	?>
		...
		<?php echo $this->Form->input('SourceCostCenter.name', array('label'=>'Origin Cost Center', 'style'=>'width:100%')); ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Movement.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Movement.id'))); ?></li>
