...
<h2><?php  __('Po');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Next PO Status'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<div id="PoTotalDiv"><?php echo $poStatuses[$level]; ?></div>
		</dd>
	...
	<div>
		<?php echo $this->Form->create('Po');?>
			<?php
				echo $this->Form->input('id', array('type'=>'hidden','value'=>$po['Po']['id']));
				echo $this->Form->input('po_status_id', array('type'=>'hidden','value'=>$level));
				echo $this->Form->input('cancel_notes', array('style'=>'width:98%','value'=>$po['Po']['cancel_notes']));
		...
		<?php
			...
			<tr<?php echo $class;?>>
				...
				<td class="left">
					...
					$this->Html->link($po['NpbDetail'][0]['npb_id'], 
					array('controller'=>'npbs', 'action'=>'view', $po['NpbDetail'][0]['npb_id'])):
					"";?>
				</td>
