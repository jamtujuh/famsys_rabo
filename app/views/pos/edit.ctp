...
<?php echo $this->Form->create('Po');?>
	<fieldset>
		...
		<?php echo $this->Form->input('po_status_id', array('type'=>'hidden', 'value'=>status_po_draft_id)); ?>
		<?php echo $this->Form->input('description', array('style'=>'width:98%', 'maxlength'=>'255')); ?>
		<?php echo $this->Form->input('billing_address', array('style'=>'width:98%', 'maxlength'=>'255')); ?>
		<?php echo $this->Form->input('shipping_address', array('style'=>'width:98%', 'maxlength'=>'255')); ?>
		...
		<?php echo $this->Form->input('payment_term'); ?>
		<?php echo $this->Form->input('daily_penalty'); ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Po.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Po.id'))); ?></li>
