...
<?php echo $this->Form->create('RequestType');?>
	<fieldset>
 		<legend><?php __('Edit Request Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('RequestType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('RequestType.id'))); ?></li>
