...
<h2><?php  __('Request Type');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $requestType['RequestType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $requestType['RequestType']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Descr'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $requestType['RequestType']['descr']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Request Type', true), array('action' => 'edit', $requestType['RequestType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Request Type', true), array('action' => 'delete', $requestType['RequestType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $requestType['RequestType']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Request Types', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Request Type', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($requestType['Npb'] as $npb):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $npb['request_type_id'];?></td>
			...
			<td><?php echo $npb['cancel_notes'];?></td>
			<td><?php echo $npb['cancel_by'];?></td>
			<td><?php echo $npb['cancel_date'];?></td>
			<td class="actions">
