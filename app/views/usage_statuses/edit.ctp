...
<?php echo $this->Form->create('ImportStatus');?>
	<fieldset>
 		<legend><?php __('Edit Import Status'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ImportStatus.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ImportStatus.id'))); ?></li>
