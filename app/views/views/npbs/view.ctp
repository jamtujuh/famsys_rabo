...
$class = ' class="altrow"'; ?>
      ...
      <div class="doc_actions">
            <ul>
				<?php if($npb['Npb']['npb_status_id'] != status_npb_done_id && $npb['Npb']['npb_status_id'] != status_npb_movement_id && $npb['Npb']['npb_status_id'] != status_npb_processing_id){?>
						<li>
      ...
      <table id="npb_details" cellpadding = "0" cellspacing = "0">
            ...
            <?php if ($this->Session->read('Npb.can_edit_price')) : ?>
                  ...
                  <tr>
                        ...
                        <th class="actions"><?php __('Proses Type'); ?></th>
                  </tr>	
                  <?php if (!empty($npb['NpbDetail']['npb_id'])): ?>
		  ...
		  <?php
			...
			?>
				...
				<?php //};
				?>
			<?php }else if($group_id == gs_group_id && $npbDetail['process_type_id'] == 2){ ?>
					<tr<?php echo $class; ?>>
						<td><?php echo $i; ?></td>
						<td class="left"><?php echo $npbDetail['item_code']; ?></td>
						<td class="left"><?php echo $npbDetail['item_name']; ?></td>
			...
			<?php };?>
					...
					<?php if ($this->Session->read('Npb.can_edit')) : ?>
                        <tr id="newRecord">
                              ...
                              <td></td>
                              <td>
								<?php if ($request_type_id == 5){
									
								}else{
									echo $this->Form->input('currency_id', array('maxlength'=>'50','options'=>$currencies)); 
								}?>
							  </td>
                              <td>
								<?php if ($request_type_id != '3' && $request_type_id != '5'){
									echo $this->Form->input('price', array('maxlength'=>'50'));
								}else if($request_type_id == 5 && $group_id != rac_group_id && $group_id != normal_user_group_id){
									echo $this->Form->input('price', array('maxlength'=>'50'));
								}
								?>								
							  </td>
